...
while True:
    try:
        opcion = input("¿Quieres ejecutar la versión hecha con listas o json? ").lower()
        if (opcion == 'listas') or (opcion == 'lista'):
            '''
            PROGRAMA HECHO CON LISTAS:
            ''' 
            ...
            '''
            PROGRAMA HECHO CON JSON:
            '''
            print("Todavía no está implementado")
